...
public class TestHotSwap {
    ...
    public static void main(String args[]) throws MalformedURLException {
        ...
        try {
            //E:\workspace\APG02\work\tfoatest\target\classes
            URL[] urls = new URL[]{ new URL("file:///E:\\workspace\\APG02\\work\\tfoatest\\target\\classes\\") };
            HotSwapClassLoader c1 = new HotSwapClassLoader(urls, a.getClass().getClassLoader());
            Class clazz = c1.load("util.tom.A");  // 用hot swap重新加载类A
